...
router.get(`${process.env.BASE_PATH}/current/:city`, weatherController.currentByCity);
router.get(`${process.env.BASE_PATH}/current`, weatherController.current);
router.get(`${process.env.BASE_PATH}/forecast/:city`, weatherController.forecastByCity);
